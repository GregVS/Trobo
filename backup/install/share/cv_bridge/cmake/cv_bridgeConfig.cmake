...
if("FALSE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/greg/trobo_cpp/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/greg/trobo_cpp/devel)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/greg/trobo_cpp/install)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/greg/trobo_cpp/install/${idir}'.  ${_report}")
    endif()
