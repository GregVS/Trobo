...
if("FALSE" STREQUAL "TRUE")
  set(stereo_msgs_SOURCE_PREFIX /home/greg/trobo_cpp/src/common_msgs/stereo_msgs)
  set(stereo_msgs_DEVEL_PREFIX /home/greg/trobo_cpp/devel)
  ...
  set(stereo_msgs_INSTALL_PREFIX /home/greg/trobo_cpp/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/greg/trobo_cpp/install/${idir}'.  ${_report}")
    endif()
