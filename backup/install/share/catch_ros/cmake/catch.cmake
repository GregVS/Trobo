...
function(catch_add_test target)
	add_executable(${target}
		${ARGN}
		/home/greg/trobo_cpp/install/share/catch_ros/meta_info.cpp
	)
	...
	target_link_libraries(${target}
		/home/greg/trobo_cpp/install/lib/libcatch_ros_standalone.so
	)
...
function(catch_add_rostest_node target)
	...
	target_link_libraries(${target}
		/home/greg/trobo_cpp/install/lib/libcatch_ros_rostest.so
	)
endfunction()
