...
if("FALSE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/greg/trobo_cpp/src/vision_opencv/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/greg/trobo_cpp/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/greg/trobo_cpp/install)
...
if(NOT "include;/usr/include;/usr/include/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/greg/trobo_cpp/install/${idir}'.  ${_report}")
    endif()
